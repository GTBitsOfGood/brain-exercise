...
export default function OneLineComponent({
    ...
    return (
        <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', width: '92%', borderRadius: 12, borderWidth: 1, borderColor: '#E3EAFC', backgroundColor: '#FFF', paddingTop: '5%', paddingBottom: '5%', paddingLeft: '4%', paddingRight: '4%' }}>
