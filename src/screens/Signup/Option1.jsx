...
function SignUpOption1({ navigation }) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.root} behavior={Platform.OS === "ios" ? "padding" : "height"}>

      <View style={{ flex: 1 }}>
        <Image style={styles.image} source={logo} />
        <Text style={{ fontWeight: 'bold', fontSize: 20, color: '#4A4B57', paddingLeft: '3%', paddingTop: '2%' }}>Let's Get Started</Text>
      </View>

      <KeyboardAvoidingView style={{ flex: 5, paddingVertical: '5%', paddingHorizontal: '3%', width: '100%' }}>
        <SafeAreaView>
        ...
        <Button
          ...
          buttonStyle={{ backgroundColor: '#005AA3', borderRadius: 4, height: 0.13*(Dimensions.get('window').width) }}
