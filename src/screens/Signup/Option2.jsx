...
function SignUpOption2({ navigation }) {
  ...
  return (
    <View style={styles.root}>
      ...
      <View style={{ flex: 1, alignSelf: 'center', paddingHorizontal: '3%', margin: 0 }}>
        <Button
      ...
      <View style={{ flex: 1, paddingHorizontal: '5%', flexDirection: 'row', alignItems: 'flex-end', }}>
        <Text style={{ fontSize: 14, color: '#4A4B57' }}>Already Have an Account? </Text>
        ...
        <Pressable style={styles.button} onPress={() => navigation.navigate("HomeScreen")}>
          <Text style={{ fontSize: 14, color: '#005AA3', fontWeight: 'bold' }}>Log In</Text>
        </Pressable>
      </View>
