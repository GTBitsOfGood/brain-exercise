            ...
            onPress={() => {
              axios
                .post("/signup", {
                  name: fullName,
                  email:
                    "TODO WE HAVE TO SETUP A WAY TO COLLECT EMAIL OR REMOVE IT FROM USER MODEL ON BACKEND",
                  ...
                  password:
                    "TODO REMOVE BECAUSE WE DON'T STORE PASSWORDS (AUTH0 HANDLES IT)",
                ...
                .catch((err) => {
                  Alert.alert(
                    "Authentication error! Please try again at another time",
                  );
                });
            }}
          />
